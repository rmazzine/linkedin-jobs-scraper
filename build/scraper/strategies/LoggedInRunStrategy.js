 ...
 * @private
 */
LoggedInRunStrategy._loadJobDetails = (page, timeout = 2000) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (!loaded) {
        ...
        loaded = yield page.evaluate((detailsSelector, descriptionSelector) => {
        ...
        }, exports.selectors.details, exports.selectors.description);
        if (loaded)
            return { success: true };
 ...
 * @private
 */
LoggedInRunStrategy._paginate = (page, paginationIndex, timeout = 2000) => __awaiter(void 0, void 0, void 0, function* () {
    const pollingTime = 100;
 ...
 * @private
 */
LoggedInRunStrategy._paginate_new = (page, tag, timeout = 2000) => __awaiter(void 0, void 0, void 0, function* () {
